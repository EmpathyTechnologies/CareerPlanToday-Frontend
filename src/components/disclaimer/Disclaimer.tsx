  ...
  return (
    <div>
      ...
      <div>
        ...
        transaction, or decision based on your own personal circumstances. You should independently
        research and verify, any information that you find on our Website and wish to rely upon,
        whether for the purpose of making an investment, transaction, or other decision.
      </div>
      <h3>No Investment Advice</h3>
      <div>
        We do not provide personalized recommendations or views as to whether a career, college,
        trade school, code academy or investment approach is suited to the financial or other needs
      ...
      <div>
        ...
        individual criteria for your decisions. Where we offer valuation tools, these are solely for
        informational & educational purposes so that users can easily run their own valuations. The
        pre-defined values are simply a starting point based on assumptions. Users should not regard
        them as a substitute for their own judgment. Any resulting valuation outputs are not
        endorsed by us.
      </div>
      <h3>Data Content</h3>
      <div>
        This website, its administrators, owners, and anyone else associated with this site assume
        no responsibility or liability for any errors or omissions in the content of this site. The
